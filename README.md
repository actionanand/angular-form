...
```bash
git clone https://github.com/actionanand/angular-forms.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/angular-forms#1-skeleton angular-proj-name
```
